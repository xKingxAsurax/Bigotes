      ...
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div
          ...
          <div class="support-box text-end d-none d-xl-block">
            <span class="fs-6 secondary-font text-muted">Nuestro contacto</span>
            <h5 class="mb-0">+57 3167653739</h5>
          </div>
          <div class="support-box text-end d-none d-xl-block">
            <span class="fs-6 secondary-font text-muted">Email</span>
            <h5 class="mb-0">bigotesfelices@gmail.com</h5>
          </div>
      ...
      <nav class="main-menu d-flex navbar navbar-expand-lg ">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body justify-content-between">
            <div class=" border-0 mb-0 me-5">
              
            </div>

            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
    <li class="nav-item">
        <a href="#login" class="nav-link active">Inicio</a>
    </li>
    <li class="nav-item">
        <a href="#categories" class="nav-link">Productos</a>
    </li>

    <li class="nav-item">
        <a href="#banner-2" class="nav-link">Agenda tu cita</a>
    </li>

    <li class="nav-item">
        <a href="#banner-2-3" class="nav-link">Contáctanos</a>
    </li>
...
<script src="{{ asset('assets/js/agregarProductos.js') }}"></script>
              ...
              <div class="offset-md-3 col-md-6 my-5">
                  ...
                  <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="d-grid gap-2">
                          <button type="submit" class="btn btn-dark btn-lg rounded-1">Iniciar sesión</button>
                      </div>
                      ...
                      <div class="d-grid gap-2">
                          <a href="{{ route('register') }}" class="btn btn-outline-dark btn-lg rounded-1">Registrar</a>
                      </div>
                  </form>
              </div>
          </div>
  ...
  <section id="banner-2-3" class="my-3" style="background: #F9F3EC;">
    <div class="container">
      <div class="row flex-row-reverse banner-content align-items-center">
        <div class="img-wrapper col-12 col-md-6">
         <img src="{{ asset('assets/images/banner-img5.png') }}" class="img-fluid">

        </div>
        <div class="content-wrapper col-12 offset-md-1 col-md-5 p-5">
        <h2 class="banner-title display-1 fw-normal">Contactanos</h2>
          <div class="secondary-font text-primary text-uppercase mb-3 fs-4">+573167653739</div>
          <div class="secondary-font text-primary text-uppercase mb-3 fs-4">bigotesfelices@hotmail.com</div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="footer-menu">
          <img src="{{ asset('assets/images/logo.png') }}" alt="Bigotes Felices Logo" class="mb-3">
          <p class="fs-5">Bigotes Felices</p>
          <p class="fs-6">Tu tienda de confianza para tus mascotas.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="footer-menu">
          ...
          <ul class="menu-list list-unstyled">
            <li class="menu-item">
              <a href="#login" class="nav-link">Inicio</a>
            </li>
            <li class="menu-item">
              <a href="#categories" class="nav-link">Productos</a>
            </li>
            <li class="menu-item">
              <a href="#banner-2" class="nav-link">Contáctanos</a>
            </li>
            <li class="menu-item">
              <a href="#banner-2-3" class="nav-link">Agenda tu cita</a>
            </li>
          </ul>
        </div>
      </div>

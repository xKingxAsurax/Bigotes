...
<body>
  ...
  @extends('layouts.app') <!-- Si estás usando un layout común -->
                ...
                <div class="swiper-slide py-5">
                    <div class="row banner-content align-items-center">
                        <div class="container my-5">
                            <h1 class="text-center mb-4">Productos para {{$especie ?? 'todas las especies'}}</h1>

                            <!-- Contenedor para los productos -->
                            <div id="productos-contenedor" class="row g-4">
                                @if(isset($error))
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="card-text">
                                                    ...
                                                    <h3 class="secondary-font text-primary">${{ number_format($producto->Precio, 2) }}</h3>
